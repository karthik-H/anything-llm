...
{"prompt":"Analyze data 📊 and file 'report_final_v2.docx' with path /data/用户/文档"}
EOF

# When
echo "STEP: When — POST /api/v1/prompt with unicode and special characters"
...
echo "CODEVALID_TEST_ASSERTION_OK:send_prompt_with_special_characters"
