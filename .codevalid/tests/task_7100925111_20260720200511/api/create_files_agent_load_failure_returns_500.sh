...
# Given
echo "STEP: Given — verify authenticated module-load-failure precondition assumptions"
echo "PREREQ: this scenario requires a valid authenticated session accepted by validatedRequest middleware"
echo "PREREQ: this scenario also requires the create-files-agent module require() call to fail in the running environment"
...
echo "CODEVALID_TEST_ASSERTION_OK:create_files_agent_load_failure_returns_500"
