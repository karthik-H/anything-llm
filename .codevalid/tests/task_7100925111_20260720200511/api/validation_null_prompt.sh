...
# Given
echo "STEP: Given — prepare a request body with a null prompt"
cat > "$REQUEST_BODY_FILE" <<'EOF'
{"prompt":null}
EOF

# When
echo "STEP: When — POST /api/v1/prompt with prompt explicitly set to null"
...
echo "CODEVALID_TEST_ASSERTION_OK:validation_null_prompt"
