...
# Given
echo "STEP: Given — prepare request body without skillName"
echo "PREREQ: this validation path short-circuits before persistence when skillName is missing"
cat > "$REQUEST_BODY_FILE" <<'EOF'
{}
EOF

# When
echo "STEP: When — POST /agent-skills/whitelist/add with missing skillName"
...
# Then
echo "STEP: Then — assert required field validation error is returned"
...
echo "CODEVALID_TEST_ASSERTION_OK:add_skill_missing_skillname"
